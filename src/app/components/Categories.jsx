  ...
  return (
    <div>
        <div>
            ...
            <button className="bg-[#E7FAFE] hover:bg-[#E7FAFE] text-black rounded-xl px-6 py-2 text-sm font-semibold transition-colors">View All Categories</button>
        </div>
       <div className="grid md:grid-cols-6 sm:grid-cols-4 xs:grid-cols-2 lg:grid-cols-6 gap-8 sm:gap-4 xs:gap-4">
